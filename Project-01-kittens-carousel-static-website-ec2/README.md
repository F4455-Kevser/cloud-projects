# Project-01 : Kittens Carousel Static Website deployed on AWS EC2 using Cloudformation
...
- Customize the application by hard-coding your name instead of `Kevser` within `index.html`.
